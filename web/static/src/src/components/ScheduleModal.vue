          ...
          <div class="space-y-2">
            ...
            <div>
              ...
              <div class="block max-w-sm">
                <vue-tailwind-datepicker v-model="startDate" :formatter="formatter" :disable-date="dDate"
                  ...
                  overlay placeholder="Start date (YYYY-MM-DD)" as-single />
              </div>
            </div>
            <div>
            ...
            <div v-if="scheduleStore.scheduleEdit?.speakers">
              <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  <vue-draggable-next tag="tbody" @change="orderChanged" v-model="scheduleStore.scheduleEdit.speakers">
                    <tr v-for="(speaker, index) in scheduleStore.scheduleEdit?.speakers" :key="index"
                      class="handle bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      <td scope="row" class="px-3 py-1 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      ...
                      <td class="px-3 py-1 text-right">
                        <button @click="editSpeaker(speaker)" :data-tooltip-target="`tooltip-edit-{index}`" type="button"
                        ...
                        <button @click="deleteSpeaker(speaker.id)" :data-tooltip-target="`tooltip-delete-{index}`"
                          type="button"
                          class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-xs px-1 py-1 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                          <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 96 960 960" width="16">
                            <path
            ...
            <button v-if="scheduleStore.scheduleEdit !== null" @click="updateSchedule()" type="submit"
            ...
            <button v-else @click="addSchedule()" type="submit"
              class="w-full text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
              Save
            </button>
          </div>
...
<style>
.vtd-datepicker div div div.relative {
  width: 100%;
}
</style>
